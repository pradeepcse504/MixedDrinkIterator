...
public class CocktailMenu implements Cocktail {
    ...
    public CocktailMenu(){
        ...
        addDrink("French 75", "French 75 is a cocktail made from gin, champagne, lemon juice, and sugar. ", true, 2.5);
        ...
        addDrink("Chocolate Martini", "made with chocolate liqueur, crème de cacao, half and half, and vodka. It is every chocolate lover's dream!", true, 1.5);
        addDrink("Margarita", "A margarita is a cocktail consisting of tequila, orange liqueur, and lime juice often served with salt on the rim of the glass.", true, 3.2);
